...
def deep_dream_static_image(config, img):
    ...
    # checkpoint = torch.load('/home/vortex/deepDream/RESNET50_BIN.pth.tar')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_width", type=int, help="Resize input image to this width", default=1200)
